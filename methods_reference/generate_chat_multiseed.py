#!/usr/bin/env python3
"""Generate one Base/Public-seed condition with the frozen Qwen chat protocol."""
...
def main():
    ...
    parser.add_argument(
        "--condition",
        required=True,
        choices=["base", "public_seed2026", "public_seed2027", "public_seed2028"],
    )
    ...
    if protocol["version"] != "0.12.1" or protocol["model"]["revision"] not in args.model:
